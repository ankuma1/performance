...
class UserBehaviour(SequentialTaskSet):
    ...
    def update_vehicle_details(self):
        with self.client.post("/InsuranceWebExtJS/quote_auto.jsf", headers={"Content-Type": "application/x-www-form-urlencoded"}, data={
                                                                         "autoquote": "autoquote",
    ...
    def update_user_info(self):
        with self.client.post("/InsuranceWebExtJS/quote_auto2.jsf", headers={"Content-Type": "application/x-www-form-urlencoded"},
                                                                    data={"autoquote": "autoquote",
                                                                          ...
                                                                          "javax.faces.ViewState": self.rel},
                              cookies={"JSESSIONID": self.jsession__id,
                                       "UserSessionFilter.sessionId": self.user_filter_sessionID}, name="update user info",
    ...
    def update_car_model(self):
        with self.client.post("/InsuranceWebExtJS/quote_auto3.jsf", headers={"Content-Type": "application/x-www-form-urlencoded"},
                                                                      data={"autoquote": "autoquote",
                                                                            "autoquote:year": "2007",
                                                                            "makeCombo": "Chrysler",
