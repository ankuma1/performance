...
class UserBehaviour(SequentialTaskSet):
    ...
    def on_start(self):
        ...
        reader = ReadCsvFile("/Users/anilkumar/PycharmProjects/Demo_Locust_Project/data/credential.csv").reader()
        print(reader)
        if len(reader) > 0:
            randomValue = random.choice(reader);
            self.username = randomValue["username"]
            self.passwd = randomValue["password"]
            print(self.username)
            print(self.passwd)
        else:
